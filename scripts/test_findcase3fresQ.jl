# Case3
println("Case 3")
println("Actuals: ϵᵣ = 8.0, tanδ = 0.004\n")
...
lI = 0.73; lD = 0.05; lII = d - (lI + lD) # CWG lengths adding up to d = 3.5 inch
σstart = 644_000 # Inconel wall conductivity S/m
fQ0 = (; fres = 15.3791, Q = 1813.12) # Provided values for empty cavity
fQ = (; fres = 14.7615, Q = 1555.84) # Provided values for cavity with dielectric sample
